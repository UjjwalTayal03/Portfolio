...
const Navbar = () => {
  return (
    <div className='flex bg-[rgb(26,11,46)] text-white h-16 items-center justify-around'>
      <div className='logo w-1/3 justify-center flex'>Ujjwal's Portfolio</div>
      <div className='flex justify-evenly w-2/3 text-lg'>
        <button onClick={() => scrollToSection('skills')} className='relative border-b-2 border-transparent hover:border-white transition-all duration-300'>Skills</button>
