...
const Contact = () => {
  return (
    <div className='text-white mt-48' id='Contact'>
        ...
        <p className='w-3/4 text-sm leading-relaxed mb-6'>I'm currently looking to join a cross-functional team that values improving people's lives through accessible design. or have a project in mind? Let's connct.</p>
      ...
      <a href="https://leetcode.com/yourusername" target="_blank"><SiLeetcode /></a>
    </div>
    </div>
  )
}
